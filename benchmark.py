...
def main(new = True): 
    ...
    from gstk.tabulatehdf import tabulate_nodes
    if new:
        filend = tabulate_nodes(h5py.File(path_file))
    else:
        filend = io_importgalout(path_file)[path_file] 
    ...
    from massfunction import plot_massfunction
    plot_massfunction(fig, ax, filend, mrange, 10) 
